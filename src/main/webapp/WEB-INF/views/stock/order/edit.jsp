...
<div class="container">
    ...
    <main>
        <%@ include file="/WEB-INF/inc/sub-nav_stock.jsp" %>
			<div class="content">
			<form method="post" action="/stock/order/editok.do" autocomplete="off">
				<table class="table table-bordered">
					...
					<c:forEach items="${list}" var="dto">
						<tr>
							...
							<td class="column6-sub"><input type="text" class="form-control" value="${dto.quantity_order}" name="quantity"></td>
