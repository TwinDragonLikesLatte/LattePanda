    ...
    <main>
        <%@ include file="/WEB-INF/inc/sub-nav_stock.jsp" %>
			<div class="content">
				<table class="table table-bordered">
					...
					<c:forEach items="${list}" var="dto">
						<tr>
							...
							<td class="column5-sub"><input type="text" disabled="disabled" class="form-control" value="${dto.quantity}" ></td>
							<td class="column5-sub"><input type="text" disabled="disabled" class="form-control" value="${dto.waste}" ></td>
							<td class="column5-sub"><input type="text" disabled="disabled" class="form-control" value="${dto.pre_quantity-dto.quantity-dto.waste}" ></td>
							<td class="column6"><input type="text" disabled="disabled" class="form-control" value="${dto.etc}"></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
				...
				<input type="button" class="btn btn-primary" value="수량입력" onclick="location.href='/stock/list/edit.do';">
